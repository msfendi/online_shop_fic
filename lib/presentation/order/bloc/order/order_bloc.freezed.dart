...
class _$CreateOrderImpl implements _CreateOrder {
  const _$CreateOrderImpl(
      ...
      required final List<ProductQuantityModel> products})
      : _products = products;
  ...
  final List<ProductQuantityModel> _products;
  @override
  List<ProductQuantityModel> get products {
  ...
  @override
  String toString() {
    return 'OrderEvent.createOrder(addressId: $addressId, paymentMethod: $paymentMethod, paymentVaName: $paymentVaName, shippingService: $shippingService, shippingCost: $shippingCost, products: $products)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return createOrder(addressId, paymentMethod, paymentVaName, shippingService,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return createOrder?.call(addressId, paymentMethod, paymentVaName,
        shippingService, shippingCost, products);
  }
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    if (createOrder != null) {
      return createOrder(addressId, paymentMethod, paymentVaName,
          shippingService, shippingCost, products);
    }
    return orElse();
  }
...
abstract class _CreateOrder implements OrderEvent {
  const factory _CreateOrder(
      ...
      required final List<ProductQuantityModel> products}) = _$CreateOrderImpl;
...
mixin _$OrderState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(OrderResponse data) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(OrderResponse data)? loaded,
...
abstract class _Loaded implements OrderState {
  const factory _Loaded(final OrderResponse data) = _$LoadedImpl;
