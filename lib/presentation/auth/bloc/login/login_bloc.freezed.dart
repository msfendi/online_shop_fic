...
mixin _$LoginState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(AuthResponse authResponse) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(AuthResponse authResponse)? loaded,
...
abstract class _Loaded implements LoginState {
  const factory _Loaded(final AuthResponse authResponse) = _$LoadedImpl;
